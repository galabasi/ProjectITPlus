    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview <?php echo ($view=='addUser'||$view=='listUser')?"active":"" ?>">
        ...
        <ul class="treeview-menu">
          <li><a href="index.php?view=listUser">List User</a></li>
          <li><a href="index.php?view=addUser">Add User</a></li>
        </ul>
      </li>
      <li class="treeview <?php echo ($view=='addProvince'||$view=='listProvince')?"active":"" ?>">
        ...
        <ul class="treeview-menu">
          <li><a href="index.php?view=listProvince">List Province</a></li>
